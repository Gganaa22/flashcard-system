error id: file:///C:/Users/DELL/OneDrive/文档/flashcard/FlashcardGame.java:java/lang/String#
...
public class FlashcardGame {
    ...
    public void setFile(Stri@@ng file) {
        this.file = file;
    }
    ...
    private void showAchievements() {
        ...
        for (Card c : cards) {
            if (c.getCorrectCount() == 0 && c.getWrongCount() > 0) {
                allCorrect = false;
                }
        }
