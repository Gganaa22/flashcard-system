error id: file:///C:/Users/DELL/OneDrive/文档/flashcard/FlashcardGame.java:javax/smartcardio/Card#getCorrectCount#
file:///C:/Users/DELL/OneDrive/文档/flashcard/FlashcardGame.java
empty definition using pc, found symbol in pc: javax/smartcardio/Card#getCorrectCount#
...
public class FlashcardGame {
    ...
    private void showAchievements() {
        ...
        for (Card c : cards) {
            if (c.getWrongCount() > 0 && c.getCorrectCount@@() == 0) {
                allCorrect = false;
                break;
            }
